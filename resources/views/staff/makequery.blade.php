                        ...
                        <div class="card white darken-1">
                            <div class="card-content ">
                                <span class="card-title">Create Query</span>
                                 <div class="row">
                                     <form class="col s12" role="form" method="POST" action="{{ url('/serve/query') }}" enctype="multipart/form-data">
                                       {{ csrf_field() }}
                                       <div class="input-field col s12{{ $errors->has('number') ? ' has-error' : '' }}">
                                        ...
                                        <input name="department_id" type="hidden" value="{{$user->department_id}}" required>
                                         ...
                                         <input name="status" type="hidden" value="unanswered" required>

                                         <div class="col s12 right-align m-t-sm">
                                             <button type="submit" class="btn waves-effect waves-light teal">Query</button>
                                         </div>
                                     </form>
                                </div>
                            </div>
