                    ...
                    <div class="col s12 m12 l12">
                        <div class="card white darken-1">
                            <div class="card-content ">
                                <span class="card-title">Make Sanction</span>
                                 <div class="row">
                                     <form class="col s12" role="form" method="POST" action="/sanction" enctype="multipart/form-data">
                                       {{ csrf_field() }}
                                        ...
                                        <input name="department_id" type="hidden" value="{{$user->department_id}}" required>
                                         ...
                                         <div class="col s12 right-align m-t-sm">
                                             <button type="submit" class="btn waves-effect waves-light teal">Sanction</button>
                                         </div>
                                     </form>
                                </div>
                            </div>
