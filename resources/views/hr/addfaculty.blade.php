                        ...
                        <div class="card white darken-1">
                            <div class="card-content ">
                                <span class="card-title">Add Faculty</span>
                                 <div class="row">
                                     <form class="col s12" role="form" method="POST" action="{{ url('/savefaculty') }}">
                                       {{ csrf_field() }}
                        ...
                        <div class="card">
                          <div class="card-content">
                            <ul class="collection with-header">
                              <li class="collection-header"><h4>Available Faculties</h4></li>
                              @foreach ($faculties as $faculty)
                                  <li class="collection-item">{{$faculty->name}}</li>
                              @endforeach
