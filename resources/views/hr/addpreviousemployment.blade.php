                    ...
                    <div class="col s12 m12 l12">
                        <div class="card white darken-1">
                            <div class="card-content ">
                                <span class="card-title">Add Previous Employment</span>
                                 <div class="row">
                                     <form class="col s12" role="form" method="POST" action="{{ url('/addpreviousemployment') }}">
                                       {{ csrf_field() }}
                                         ...
                                         <div class="input-field col s12{{ $errors->has('number') ? ' has-error' : '' }}">
                                             <input id="lastpost" name="lastpostheld" type="text" class="validate" value="{{ old('lastpost') }}" required>
                                         ...
                                         <div class="col s12 right-align m-t-sm">
                                             <button type="submit" class="btn waves-effect waves-light teal">Add Previous Employment</button>
                                         </div>
                                     </form>
                                </div>
                            </div>
