...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>UNILORIN HRMS | HR QUESTIONNAIRE</title>
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    <li class="no-padding {{ (Request::is('dashboard') ? ' active' : '') }}"><a class="waves-effect waves-grey active" href="{{url('/dashboard')}}"><i class="material-icons">settings_input_svideo</i>Dashboard</a></li>
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">grid_on</i>Logout</a>
                    </li>
                </ul>
                <div class="footer">
