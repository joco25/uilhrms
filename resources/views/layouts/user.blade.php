...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>UNILORIN HRMS | STAFF</title>
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    <li class="no-padding {{ (Request::is('user') ? ' active' : '') }}"><a class="waves-effect waves-grey active" href="{{url('/dashboard')}}"><i class="material-icons">apps</i>Dashboard</a></li>
                    <li class="no-padding {{ (Request::is('profile') ? ' active' : '') }}"><a class="waves-effect waves-grey" href="{{url('/profile',auth()->user()->id)}}"><i class="material-icons">perm_contact_calendar</i>My Profile</a>
                    </li>
                    <li class="no-padding{{ (Request::is('sapplications') ? ' active' : '') }}">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">mode_edit</i>Applications<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="{{url('/apply')}}">Apply for Leave</a>
                                <li><a href="{{url('/papply')}}">Apply for promotion</a>
                                <li><a class="waves-effect waves-grey" href="{{url('/sapplications')}}">All Applications</a>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding {{ (Request::is('sapplications') ? ' active' : '') }}">
                    </li>
                    <li class="no-padding {{ (Request::is('queries') ? ' active' : '') }}"><a class="waves-effect waves-grey" href="{{url('/squeries')}}"><i class="material-icons">live_help</i>Queries</a>
                    </li>
                    <li class="no-padding {{ (Request::is('srecommendations') ? ' active' : '') }}"><a class="waves-effect waves-grey" href="{{url('/srecommendations')}}"><i class="material-icons">done_all</i>Recommendations</a>
                    </li>
                    ...
                    <li class="no-padding {{ (Request::is('ssanctions') ? ' active' : '') }}"><a class="waves-effect waves-grey" href="{{url('/ssanctions')}}"><i class="material-icons">assignment_late</i>Sanctions</a>
                    </li>
                    <li class="no-padding">
